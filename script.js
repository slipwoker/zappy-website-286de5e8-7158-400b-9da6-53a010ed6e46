document.addEventListener('DOMContentLoaded', () => {
  ...
  const navbar = document.querySelector('.navbar, nav, [class*="navbar"], header');
  if (navbar) {
      ...
      if (isValid) {
        ...
        fetch(action, options)
          ...
          .then(() => {
            ...
            successMsg.style.cssText = 'color:#38a169;padding:1rem;text-align:center;font-weight:500;';
          ...
          .catch(() => {
            ...
            errorMsg.style.cssText = 'color:#e53e3e;padding:0.5rem;text-align:center;';
  ...
  const animatedElements = document.querySelectorAll('[data-animate], .fade-in, .animate-on-scroll, [class*="reveal"]');
    ...
    const animationObserver = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          entry.target.classList.add('visible', 'animated', 'in-view');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '286de5e8-7158-400b-9da6-53a010ed6e46',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '286de5e8-7158-400b-9da6-53a010ed6e46';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '286de5e8-7158-400b-9da6-53a010ed6e46';
